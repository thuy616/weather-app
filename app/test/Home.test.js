...
describe('Home Component - mount and wrapping in <Provider>', () => {
  ...
  //   store.dispatch(actions.fetchWundergroundConditions('France', 'FR', 'Paris'));
  //   store.dispatch(actions.fetchOpenWeatherConditions('FR', 'Paris'));
  //   let action = store.getActions();
  //   // expect(action[0].type).toEqual('FETCH_WUNDERGROUND_DATA');
  //   // expect(action[0].type).toBe('FETCH_OPENWEATHER_DATA');
  // });
})
